...
public class SuspiciousCardTransferMapperTest implements MapperSupplier {
    ...
    static void init() {
        ...
        suspiciousCardTransferDto = suspiciousCardTransferSupplier.getDto(ONE, TWO, FALSE, FALSE);
    }
