...
public class RegistrationMapperTest extends ParentTest {
    ...
    private static RegistrationDto updateRegistrationDto;
    ...
    static void init() {
        ...
        registrationDto = registrationSupplier.getDto(ONE, WHITESPACE, TWO);

        updateRegistrationDto = registrationSupplier.getDto(null, WHITESPACE, TWO);
    ...
    void mergeToEntityTest() {
        final RegistrationEntity result = mapper.mergeToEntity(updateRegistrationDto, registration);
